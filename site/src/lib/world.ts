...
export const MAPS: GameMap[] = [
  {
    ...
    spots: [
      ...
      { key: 'pond', name: 'the little pond', x: 2900, d: 0.85, act: 'fish', kind: 'pond' },
  ...
  },
  {
    ...
    spots: [
      ...
      { key: 'pond2', name: 'the duck pond', x: 1400, d: 0.8, act: 'fish', kind: 'pond' },
...
export const JOBS: Job[] = [
  ...
  { key: 'priest', name: 'priest', item: 'paper', spots: ['church', 'bench3', 'square', 'pond'], act: 'read', speed: 0.8, temper: 0.1, line: 'i forgive you. reluctantly.' },
  ...
  { key: 'retired', name: 'retired', item: 'glasses', spots: ['bench2', 'bench4', 'bench5', 'church', 'pond2'], act: 'sit', speed: 0.6, temper: 0.2, line: 'in my day' },
