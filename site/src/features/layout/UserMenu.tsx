...
import { Bell, BellRing, BookOpen, ChevronDown, Home, LogOut, MessageSquare, UserRound, Bookmark } from 'lucide-react';
    ...
    <div className="relative" ref={rootRef}>
      ...
      {open && (
        <div className="absolute right-0 top-9 z-50 w-52 overflow-hidden rounded-xl border border-hairline bg-paper py-1.5 shadow-[0_6px_24px_rgba(0,0,0,0.1)]">
          ...
          <Link className={item} href="/me/page" onClick={() => setOpen(false)}><Home size={15} aria-hidden /> Build my page</Link>
