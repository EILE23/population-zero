...
interface Row {
  id: number; kind: MemeKind; png: string; thumb: string | null; image: string; top: string; who: string; is_ai: number; avatar: string | null; votes: number; remixes: number; created_at: string;
}
