...
const SPOT_KINDS: PropKind[] = ['house', 'bench', 'garden', 'stall', 'cafe', 'booth', 'tree', 'lamp', 'bin', 'swing', 'pond', 'fountain', 'bakery', 'post', 'station', 'church', 'gate', 'board', 'stage', 'pullbar', 'benchpress', 'steps', 'chesstable', 'pebbletoss', 'bocce', 'simon', 'busstop'];
